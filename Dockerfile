...
RUN echo "" >> .bashrc && \
    ...
    echo "fi" >> .bashrc && \
    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/.mysetenv.bash
...
RUN ./prepare && \
    ...
    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/obsys.dat
...
RUN mv observatories.dat observatories.dat_ORIGINAL && \
    ...
    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/observatories.dat && \
    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/aliases
...
RUN mv Telescopes.h Telescopes.h_ORIGINAL && \
    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/Telescopes.h
WORKDIR $PSRCHIVE/Base/Extensions
RUN mv Telescopes.C Telescopes.C_ORIGINAL && \
    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/Telescopes.C
WORKDIR $PSRCHIVE/Util/tempo
RUN mv itoa.C itoa.C_ORIGINAL && \
    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/itoa.C
WORKDIR $PSRCHIVE
RUN ./bootstrap && \
    ...
    make install
WORKDIR $HOME
RUN wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/.psrchive.cfg
...
RUN mv aliases.c aliases.c_ORIGINAL && \
    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/aliases.c
WORKDIR $SIGPROC
RUN ./bootstrap && \
...
RUN mv _ppgplot.c _ppgplot.c_ORIGINAL && \
    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/_ppgplot.c
...
#    wget https://raw.githubusercontent.com/mserylak/pulsar_docker/master/stock_complete_suite/setup.py
#USER root
#RUN python setup.py install --record list.txt
#USER psr
