...
extension_metas = (
    # name, sources, depends, libraries, extra_compile_args, extra_link_args
    (
        "casacore.fitting._fitting",
        ["src/fit.cc", "src/fitting.cc"],
        ["src/fitting.h"],
        ['casa_scimath', 'casa_scimath_f', boost_python, casa_python],
        ['-I/home/psr/software/casacore/build/install/include'],
        ['-L/home/psr/software/casacore/build/install/lib'],
    ),
    (
...
for meta in extension_metas:
    name, sources, depends, libraries, extra_compile_args, extra_link_args = meta
